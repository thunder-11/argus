...
export default function CommandPalette() {
  ...
  const navigationCommands = [
    ...
    { title: 'Reports — Sec 94 BNSS & Sec 63 BSA Archive', category: 'Navigation', icon: '📑', path: '/reports' },
    { title: 'System Status — Indexers & Nodes', category: 'System', icon: '🟢', path: '/system-status' },
  ...
  const allItems = [...navigationCommands, ...caseCommands];
  ...
  return (
    <div
      style={{
        position: 'fixed', inset: 0, background: 'rgba(5, 7, 10, 0.8)',
    ...
    >
      <div
        style={{
          ...
          border: '1px solid var(--border-copper)', borderRadius: 'var(--radius-lg)',
          boxShadow: '0 20px 40px rgba(0, 0, 0, 0.7), 0 0 20px rgba(200, 109, 59, 0.2)',
      ...
      >
        ...
        <div style={{
          ...
          />
          <span style={{
            fontSize: '0.7rem', color: 'var(--text-muted)', background: 'var(--bg-card)',
            padding: '3px 7px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-default)',
        ...
        <div style={{ maxHeight: '380px', overflowY: 'auto', padding: '8px' }}>
          {filteredItems.length === 0 ? (
            <div style={{ padding: '24px', textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
              No matching investigations or commands found.
            </div>
          ) : (
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isSelected ? 'rgba(200, 109, 59, 0.15)' : 'transparent',
                    border: `1px solid ${isSelected ? 'var(--border-copper)' : 'transparent'}`,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                      <div style={{ fontSize: '0.85rem', fontWeight: 800, color: isSelected ? 'var(--accent-copper-light)' : 'var(--text-primary)' }}>
                        {item.title}
                      </div>
                      {item.subtitle && (
                  ...
                  <span style={{
                    ...
                    padding: '2px 6px', borderRadius: 4, border: '1px solid var(--border-default)',
                  }}>
                    {item.category}
                  </span>
                </div>
        ...
        <div style={{
          ...
          background: 'var(--bg-secondary)', fontSize: '0.725rem', color: 'var(--text-muted)',
        }}>
          <div>Use <kbd style={{ padding: '1px 5px', background: 'var(--bg-card)', borderRadius: 3, border: '1px solid var(--border-default)' }}>↑</kbd> <kbd style={{ padding: '1px 5px', background: 'var(--bg-card)', borderRadius: 3, border: '1px solid var(--border-default)' }}>↓</kbd> to navigate, <kbd style={{ padding: '1px 5px', background: 'var(--bg-card)', borderRadius: 3, border: '1px solid var(--border-default)' }}>Enter</kbd> to select</div>
          <div style={{ color: 'var(--accent-copper)' }}>CFAS Forensics Command Deck</div>
        </div>
      </div>
    </div>
  );
